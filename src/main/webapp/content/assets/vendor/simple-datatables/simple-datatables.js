          ...
          class r {
            ...
            order(t) {
              ...
              t.forEach((t, i) => {
                (n = o.headings[t]),
                  ...
                  (e.sortable = r),
                  l[0].push(e),
                  o.hiddenColumns.includes(t) || ((s = n.cloneNode(!0)), (s.originalCellIndex = i), (s.sortable = r), l[1].push(s));
              }),
                o.data.forEach((e, s) => {
                  (i = e.cloneNode(!1)),
                    (a = e.cloneNode(!1)),
                    ...
                    t.forEach(t => {
                      (h = e.cells[t].cloneNode(!0)),
                        ...
                        i.appendChild(h),
                        o.hiddenColumns.includes(t) || ((h = e.cells[t].cloneNode(!0)), (h.data = e.cells[t].data), a.appendChild(h));
                    }),
                    l[2].push(i),
                    l[3].push(a);
                }),
            ...
            add(t) {
              ...
              if (!this.dt.headings.length)
                return this.dt.insert({ headings: [t.heading], data: t.data.map(t => [t]) }), void this.rebuild();
            ...
            sort(t, e, s) {
              ...
              Promise.all(p).then(n => {
                ...
                Array.from(r).forEach(e => {
                  ...
                  'desc' == e
                    ? ((u = a(h, -1)), (g = a(l, -1)), c.classList.remove('asc'), c.classList.add('desc'))
                    : ((u = a(l, 1)), (g = a(h, 1)), c.classList.remove('desc'), c.classList.add('asc')),
              ...
              if (o.type) {
                ...
                if (i.length) {
                  if ('txt' === o.type || 'csv' === o.type) {
                    ...
                    for (h = `INSERT INTO \`${o.tableName}\` (`, n = 0; n < s.length; n++)
