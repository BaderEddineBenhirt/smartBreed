          ...
          function () {
            ...
            return o('ContentSlotsDistributor', { attrs: { 'slot-key': e.$parent.slotKey } }, [
              o('h1', { attrs: { id: 'locale' } }, [
                o('a', { staticClass: 'header-anchor', attrs: { href: '#locale' } }, [e._v('#')]),
                e._v(' Locale'),
              ]),
              e._v(' '),
              o('p', [
              ...
              o('p', [
                ...
                o(
                  ...
                  [e._v('Unicode BCP 47 locale identifier'), o('OutboundLink')],
                  1
                ),
                e._v('.'),
              ]),
              e._v(' '),
              o('p', [e._v('A Unicode BCP 47 locale identifier consists of')]),
              e._v(' '),
              o('ol', [
                ...
                e._v(' '),
                o('li', [e._v('(optionally) one or more variant codes, and')]),
                e._v(' '),
                o('li', [e._v('(optionally) one or more extension sequences,')]),
              ]),
              e._v(' '),
              o('p', [e._v('with all present components separated by hyphens.')]),
              e._v(' '),
              o('p', [e._v('By default the chart is using the default locale of the platform which is running on.')]),
              e._v(' '),
              o('h2', { attrs: { id: 'configuration-options' } }, [
                o('a', { staticClass: 'header-anchor', attrs: { href: '#configuration-options' } }, [e._v('#')]),
              ...
              o('table', [
                ...
                o('tbody', [
                  o('tr', [
                    ...
                    e._v(' '),
                    o('td', [
                      e._v('a string with a BCP 47 language tag, leveraging on '),
                      o(
                        'a',
                        {
                          attrs: {
