        ...
        n = Object(a.a)(
          ...
          function () {
            ...
            return o('ContentSlotsDistributor', { attrs: { 'slot-key': e.$parent.slotKey } }, [
              o('h3', { attrs: { id: 'common-tick-options-to-all-cartesian-axes' } }, [
                o('a', { staticClass: 'header-anchor', attrs: { href: '#common-tick-options-to-all-cartesian-axes' } }, [e._v('#')]),
                e._v(' Common tick options to all cartesian axes'),
              ]),
              e._v(' '),
              o('p', [e._v('Namespace: '), o('code', [e._v('options.scales[scaleId].ticks')])]),
              e._v(' '),
              o('table', [
                o('thead', [
                  o('tr', [
                ...
                o('tbody', [
                  ...
                  o('tr', [
                    ...
                    o(
                      'td',
                      [
                        e._v('The tick alignment perpendicular to the axis. Can be '),
                        o('code', [e._v("'near'")]),
                        e._v(', '),
                        o('code', [e._v("'center'")]),
                        e._v(', or '),
                        o('code', [e._v("'far'")]),
                        e._v('. See '),
                        o('RouterLink', { attrs: { to: '/axes/cartesian/#tick-alignment' } }, [e._v('Tick Alignment')]),
                      ],
                      1
                    ),
                  ]),
                  ...
                  o('tr', [
                    ...
                    e._v(' '),
                    o('td', [
                      e._v('Padding between the ticks on the horizontal axis when '),
                      o('code', [e._v('autoSkip')]),
                      e._v(' is enabled.'),
                    ]),
                  ]),
                  ...
                  o('tr', [
                    ...
                    o('td', [
                      ...
                      e._v(' and '),
                      o('code', [e._v('max')]),
                      e._v(' values be presented as ticks even if they are not "nice".'),
                    ]),
                  ]),
                  e._v(' '),
                  o('tr', [
                    ...
                    o('td', [
                      ...
                      o('em', [e._v('Note: this can cause labels at the edges to be cropped by the edge of the canvas')]),
                    ]),
                  ]),
                  e._v(' '),
                  o('tr', [
                    ...
                    o('td', [
                      ...
                      o('em', [e._v('Note: Only applicable to horizontal scales.')]),
                    ]),
                  ]),
                  e._v(' '),
                  o('tr', [
                    ...
                    o('td', [o('code', [e._v('0')])]),
                    e._v(' '),
                    o('td', [e._v('Minimum rotation for tick labels. '), o('em', [e._v('Note: Only applicable to horizontal scales.')])]),
                  ]),
                  e._v(' '),
                  o('tr', [
                    ...
                    e._v(' '),
                    o('td', [
                      e._v('Flips tick labels around axis, displaying the labels inside the chart instead of outside. '),
                      o('em', [e._v('Note: Only applicable to vertical scales.')]),
                    ]),
                  ]),
                  e._v(' '),
                  o('tr', [
                  ...
                  o('tr', [
                    ...
                    o('td', [o('code', [e._v('11')])]),
                    e._v(' '),
                    o('td', [e._v('Maximum number of ticks and gridlines to show.')]),
                  ]),
                ]),
              ]),
            ]);
