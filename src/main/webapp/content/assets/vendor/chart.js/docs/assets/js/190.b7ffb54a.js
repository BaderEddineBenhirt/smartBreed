            ...
            return a(
              ...
              [
                a('h1', { attrs: { id: 'animation-progress-bar' } }, [
                  a('a', { staticClass: 'header-anchor', attrs: { href: '#animation-progress-bar' } }, [t._v('#')]),
                  t._v(' Animation Progress Bar'),
                ]),
                t._v(' '),
                a('h2', { attrs: { id: 'initial-animation' } }, [
                  a('a', { staticClass: 'header-anchor', attrs: { href: '#initial-animation' } }, [t._v('#')]),
                  t._v(' Initial animation'),
                ]),
                t._v(' '),
                a('p', [a('progress', { staticStyle: { width: '100%' }, attrs: { id: 'initialProgress', max: '1', value: '0' } })]),
                t._v(' '),
                a('h2', { attrs: { id: 'other-animations' } }, [
                  a('a', { staticClass: 'header-anchor', attrs: { href: '#other-animations' } }, [t._v('#')]),
                  t._v(' Other animations'),
                ]),
                t._v(' '),
                a('p', [a('progress', { staticStyle: { width: '100%' }, attrs: { id: 'animationProgress', max: '1', value: '0' } })]),
                t._v(' '),
                a('chart-editor', {
                  attrs: {
                    ...
                    [
                      ...
                      a('ul', [
                        a(
                          'li',
                          [
                            a('RouterLink', { attrs: { to: '/configuration/animations.html#animation-callbacks' } }, [
