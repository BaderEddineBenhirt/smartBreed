          ...
          function () {
            ...
            return a('ContentSlotsDistributor', { attrs: { 'slot-key': t.$parent.slotKey } }, [
              a('h1', { attrs: { id: 'data-decimation' } }, [
                a('a', { staticClass: 'header-anchor', attrs: { href: '#data-decimation' } }, [t._v('#')]),
              ...
              a('p', [
                ...
                a('a', { attrs: { href: '#requirements' } }, [t._v('requirements')]),
                t._v(' to ensure that it will work with the chart you want to create.'),
              ]),
              t._v(' '),
              a('h2', { attrs: { id: 'configuration-options' } }, [
                a('a', { staticClass: 'header-anchor', attrs: { href: '#configuration-options' } }, [t._v('#')]),
                ...
                a('tbody', [
                  ...
                  a('tr', [
                    ...
                    a('td', [
                      ...
                      a('a', { attrs: { href: '#decimation-algorithms' } }, [t._v('more...')]),
                    ]),
                  ]),
                  t._v(' '),
                  a('tr', [
                  ...
                  a('tr', [
                    ...
                    a('td', [
                      ...
                      a('br'),
                      t._v('The number of point after decimation can be higher than the '),
              ...
              a('h2', { attrs: { id: 'decimation-algorithms' } }, [
                a('a', { staticClass: 'header-anchor', attrs: { href: '#decimation-algorithms' } }, [t._v('#')]),
                t._v(' Decimation Algorithms'),
              ]),
              t._v(' '),
              a('p', [t._v('Decimation algorithm to use for data. Options are:')]),
              t._v(' '),
              a('ul', [a('li', [a('code', [t._v("'lttb'")])]), t._v(' '), a('li', [a('code', [t._v("'min-max'")])])]),
              t._v(' '),
              a('h3', { attrs: { id: 'largest-triangle-three-bucket-lttb-decimation' } }, [
                a('a', { staticClass: 'header-anchor', attrs: { href: '#largest-triangle-three-bucket-lttb-decimation' } }, [t._v('#')]),
              ...
              a('p', [
                a(
                  'a',
                  {
                    attrs: { href: 'https://github.com/sveinn-steinarsson/flot-downsample', target: '_blank', rel: 'noopener noreferrer' },
                  },
              ...
              a('h3', { attrs: { id: 'min-max-decimation' } }, [
                a('a', { staticClass: 'header-anchor', attrs: { href: '#min-max-decimation' } }, [t._v('#')]),
              ...
              a('h2', { attrs: { id: 'requirements' } }, [
                a('a', { staticClass: 'header-anchor', attrs: { href: '#requirements' } }, [t._v('#')]),
                t._v(' Requirements'),
              ]),
              t._v(' '),
              a('p', [t._v('To use the decimation plugin, the following requirements must be met:')]),
              t._v(' '),
              a('ol', [
                a(
                  'li',
                  [
                    ...
                    a('RouterLink', { attrs: { to: '/charts/line.html#general' } }, [a('code', [t._v('indexAxis')])]),
                    t._v(' of '),
                    a('code', [t._v("'x'")]),
                  ],
                  1
                ...
                a(
                  ...
                  [
                    ...
                    a('RouterLink', { attrs: { to: '/axes/cartesian/linear.html' } }, [a('code', [t._v("'linear'")])]),
                    t._v(' or '),
                    a('RouterLink', { attrs: { to: '/axes/cartesian/time.html' } }, [a('code', [t._v("'time'")])]),
                    t._v(' type axis'),
                  ],
                  1
                ),
                ...
                a(
                  ...
                  [
                    ...
                    a('RouterLink', { attrs: { to: '/general/data-structures.html#dataset-configuration' } }, [
                      a('code', [t._v('parsing')]),
                    ]),
                    t._v(' must be '),
                    a('code', [t._v('false')]),
                ...
                t._v(' '),
                a('li', [
                  t._v('The dataset object must be mutable. The plugin stores the original data as '),
              ...
              a('h2', { attrs: { id: 'related-samples' } }, [
                a('a', { staticClass: 'header-anchor', attrs: { href: '#related-samples' } }, [t._v('#')]),
                t._v(' Related Samples'),
              ]),
              t._v(' '),
              a('ul', [a('li', [a('a', { attrs: { href: '../samples/advanced/data-decimation' } }, [t._v('Data Decimation Sample')])])]),
            ]);
          },
          [],
          !1,
