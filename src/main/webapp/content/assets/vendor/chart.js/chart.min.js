...
!(function (t, e) {
      ...
      ? (function (t, e, i, s) {
          ...
          for (const t of e) {
            ...
            for (u = d + 1; u <= t.end; u++) {
              const r = i[u % l];
              (e = Ci(
                s.setContext(_i(n, { type: 'segment', p0: o, p1: r, p0DataIndex: (u - 1) % l, p1DataIndex: u % l, datasetIndex: a }))
              )),
  ...
  function fn(t) {
    return (
      oe() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t
    );
  }
  const gn = {},
    pn = t => {
  ...
  class bn {
    constructor(t, i) {
      ...
      (this.id = e()),
        ...
        (gn[this.id] = this),
        r && l
          ? (mt.listen(this, 'complete', dn), mt.listen(this, 'progress', un), this._initialize(), this.attached && this.update())
  ...
  function Dn(t, e, i, s) {
    ...
    'middle' === n &&
      i &&
      ((t.enableBorderRadius = !0), (i._top || 0) === s ? (n = h) : (i._bottom || 0) === s ? (n = c) : ((o[On(c, a, r, l)] = !0), (n = h))),
      (o[On(n, a, r, l)] = !0),
      (t.borderSkipped = o);
  }
  function On(t, e, i, s) {
  ...
  class io extends Es {
    ...
    draw(t, e) {
      ...
      this.skip ||
        ...
        ((t.strokeStyle = i.borderColor), (t.lineWidth = i.borderWidth), (t.fillStyle = i.backgroundColor), Me(t, i, this.x, this.y));
    }
    getRange() {
      const t = this.options || {};
  ...
  (ho.id = 'bar'),
    (ho.defaults = { borderSkipped: 'start', borderWidth: 0, borderRadius: 0, inflateAmount: 'auto', pointStyle: void 0 }),
    ...
    s &&
      ...
      (function (t, e) {
        ...
        t.save(),
          'x' === l &&
            o !== n &&
            (Do(t, s, a.top), Oo(t, { line: i, target: s, color: n, scale: r, property: l }), t.restore(), t.save(), Do(t, s, a.bottom));
        ...
        for (const t of s) {
          ...
          for (const e of h) {
            const s = po(i, o[e.start], o[e.end], e.loop),
              r = Si(t, n, s);
            for (const t of r)
              a.push({ source: t, target: e, start: { [i]: bo(l, s, 'start', Math.max) }, end: { [i]: bo(l, s, 'end', Math.min) } });
          }
        }
        return a;
      })(i, s, n);
      ...
      this.legendItems.forEach((v, w) => {
        ...
        l.setWidth(this.width),
          x
            ...
            : w > 0 &&
              D + y > this.bottom &&
              ((P = g.x = P + e[g.line].width + d), g.line++, (D = g.y = ut(n, this.top + _ + d, this.bottom - e[g.line].height)));
        !(function (t, e, i) {
  ...
  function Ho(t, e) {
    ...
    if (
      ((x += t.beforeBody.length + t.afterBody.length), u && (m += u * h.lineHeight + (u - 1) * e.titleSpacing + e.titleMarginBottom), x)
    ) {
  ...
  class Go extends Es {
    ...
    getContext() {
      return (
        this.$context ||
        (this.$context =
          ((t = this.chart.getContext()), (e = this), (i = this._tooltipItems), _i(t, { tooltip: e, tooltipItems: i, type: 'tooltip' })))
      );
      var t, e, i;
    }
    getTitle(t, e) {
  ...
  class ta extends $s {
    ...
    parse(t, e) {
      ...
      return ((t, e) =>
        null === t
          ? null
          : Z(Math.round(t), 0, e))((e = isFinite(e) && s[e] === t ? e : Qo(s, t, r(e, t), this._addedLabels)), s.length - 1);
    }
    determineDataLimits() {
  ...
  class ia extends $s {
    ...
    buildTicks() {
      ...
      const n = (function (t, e) {
        ...
        for (
          b &&
          (u && w !== a ? (s.push({ value: a }), w < a && D++, N(Math.round((w + D * S) * v) / v, a, ea(a, y, t)) && D++) : w < a && D++);
          D < k;
          ++D
        )
  ...
  function xa(t, e) {
    ...
    return (
      ...
      null === l ? null : (a && (l = 'week' !== a || (!B(r) && !0 !== r) ? s.startOf(l, a) : s.startOf(l, 'isoWeek', r)), +l)
    );
  }
  function _a(t, e, i, s) {
    const n = ma.length;
