...
!(function () {
  ...
  const at = (e, t, o) => {
    ...
    jt = (e, t) =>
      ((e, t, o = y) => (o(t) ? C.none() : D(e, Z(t)) ? C.some(t) : ct(t, e.join(','), e => we(e, 'table') || o(e))))(['td', 'th'], e, t),
    It = e => _t(e, 'th,td'),
    ...
    co = e => {
      const t = e.current,
        o = e.version,
        n = e => () => t === e;
      return { current: t, version: o, isEdge: n(no), isChromium: n(ro), isIE: n('IE'), isOpera: n(so), isFirefox: n(lo), isSafari: n(ao) };
    },
  ...
  const To = () => So(),
    ...
    No = e =>
      ((e, t) => {
        ...
        return 'border-box' === t
          ? n
          : ((e, t, o, n) =>
              t - Do(e, 'padding-left', 0) - Do(e, 'padding-right', 0) - Do(e, 'border-left-width', 0) - Do(e, 'border-right-width', 0))(
              e,
              n
            );
      })(e, 'content-box'),
    ...
    Dn = rn({ delta: h, edge: bn, positions: e => Tn(vn, yn, e) }, { delta: e => -e, edge: wn, positions: e => Tn(yn, vn, e) }),
  ...
  const Hr = (e, t, o, n) => {
    ...
    Vr = Fr(),
    $r = (e, t) =>
      ((e, t, o) => (o.length > 0 ? ((e, t, o, n) => n(e, t, o[0], o.slice(1)))(e, t, o, Hr) : C.none()))(Vr, (t, o) => e(o), t),
    Ur = e => ct(e, 'table'),
    Gr = (e, t, o) => {
    ...
    Yr = (e, t, o) => mt(e, t).bind(t => mt(e, o).bind(e => $r(Ur, [t, e]).map(o => ({ first: t, last: e, table: o })))),
    Jr = (e, t, o, n, r) =>
      ((e, t) => L(e, e => we(e, t)))(e, r).bind(e =>
        ((e, t, o) =>
          ...
          ((e, t) =>
            ct(e, 'table').bind(o =>
              mt(o, t).bind(t => Gr(t, e).bind(e => e.boxes.map(t => ({ boxes: t, start: e.start, finish: e.finish }))))
            ))(e, n)
        )
      ),
    Qr = (e, t) => Kr(e, t),
    ...
    ts = (e, t, o) =>
      t.length <= 1 ? C.none() : Xr(e, o.firstSelectedSelector, o.lastSelectedSelector).map(e => ({ bounds: e, cells: t })),
    os = {
        ...
        l = (t, o) => {
          const n = ((e, t) => {
              const o = it(e, t).getOrThunk(() => {
                ...
                return 'thead' === t ? Hs(e, 'caption,colgroup', o) : 'colgroup' === t ? Hs(e, 'caption', o) : We(e, o), o;
              });
              return je(o), o;
            })(e, o),
            l = ('colgroup' === o ? s : r)(t);
      ...
      ((e, t, o, n) => {
        t > 0 &&
          ...
          N(e, e => {
            ...
            let s = 0;
            const l = n();
            for (; e.cells.length > t + s && o(r.element, e.cells[t + s].element); ) Ao(e, t + s, Ke(l, !0, e.cells[t + s].isLocked)), s++;
          });
      })(t, e, r, n.cell);
      const s = ll(o, t),
        l = ml(o, s, n),
    ...
    gl = (e, t, o, n, r) => {
      ((e, t, o, n) => {
        const r = jo(e).rows;
        if (t > 0 && t < r.length) {
          const e = ((e, t) => W(e, (e, o) => (O(e, e => t(e.element, o.element)) ? e : e.concat([o])), []))(r[t - 1].cells, o);
          N(e, e => {
            let s = C.none();
    ...
    hl = (e, t, o, n, r) => {
      ...
      return [
        ...
        ((e, t, o, n) => Io(e, e => n(e, o), t))(
          s[o],
          (e, o) => (t > 0 && t < s.length && n(_o(s[t - 1], o), _o(s[t], o)) ? Lo(s[t], o) : Ke(r(e.element, n), !0, e.isLocked)),
          n,
          r
        ),
        ...c,
    ...
    Nl = e => W(e, (e, t) => (O(e, e => e.column === t.column) ? e : e.concat([t])), []).sort((e, t) => e.column - t.column),
    Bl = ae('col'),
    zl = ae('colgroup'),
    Al = e => 'tr' === Z(e) || zl(e),
      ...
      const t = ae('br'),
        o = e =>
          hr(e)
            .bind(o => {
              const n = ke(o)
                .map(e => !!Fl(e) || (!!((e, t) => D(['br', 'img', 'hr', 'input'], e.property().name(t)))(Pl, e) && 'img' !== Z(e)))
                .getOr(!1);
              return Re(o).map(r => {
                return !0 === n || 'li' === Z((s = r)) || at(s, Hl).isSome() || t(o) || (Fl(r) && !ye(e, r)) ? [] : [pe.fromTag('br')];
                var s;
              });
            })
            .getOr([]),
    ...
    ia = Js(
      (e, t, o, n) => {
        const r = t[0].row,
          s = Kl(t),
          l = A(s, (e, t) => ({ grid: hl(e.grid, r, t.row + e.delta, o, n.getOrInit), delta: e.delta + 1 }), { grid: e, delta: 0 }).grid;
    ...
    da = Js(
      (e, t, o, n) => {
        const r = t.details,
          s = Nl(r),
          l = s[0].column,
          a = A(s, (e, t) => ({ grid: pl(e.grid, l, t.column + e.delta, o, n.getOrInit), delta: e.delta + 1 }), { grid: e, delta: 0 }).grid;
    ...
    Ta = Js(
      ...
      (e, t) => jt(t.element).bind(o => Ks(e, o).map(e => ({ ...e, generators: t.generators, clipboard: t.clipboard }))),
      ea,
      f,
      _l
    ),
    ...
    lc = { ...rc, from: e => (bt(e, '%') ? sc('%', rc.percent, e) : bt(e, 'px') ? sc('px', rc.pixels, e) : rc.invalid(e)) },
    ac = (e, t, o) => {
      const n = lc.from(o),
        r = I(e, e => '0px' === e)
          ? ((e, t) => {
  ...
  const Dc = 'x-tinymce/dom-table-',
            ...
            (t =>
              jc(e).each(n => {
                Ya(e) ||
                  ...
                  Ga(e) ||
                  Ft(n, o).each(o => {
                    'relative' !== t || gc(o) ? ('fixed' !== t || hc(o) ? 'responsive' !== t || pc(o) || yc(o) : vc(o)) : bc(o),
                      kr(o),
                      Wa(e, o.dom, _a);
                  });
              }))(n),
    ...
    Fc = { before: Pc.before, on: Pc.on, after: Pc.after, cata: (e, t, o, n) => e.fold(t, o, n), getStart: e => e.fold(h, h, h) },
  ...
  const Zc = (e, t, o, n) => ({ start: e, soffset: t, finish: o, foffset: n }),
    ...
    ii = (e, t, o, n, r = ci) =>
      L(r, e => e.current === o).bind(o => o.current(e, t, n, o.next).orThunk(() => o.fallback.bind(o => ii(e, t, o, n)))),
    mi = (e, t, o, n, r, s) =>
      ii(e, t, n, r).bind(t => (s(t.item) ? C.none() : o(t.item) ? C.some(t.item) : mi(e, t.item, o, t.mode, r, s))),
    di = e => t => 0 === e.property().children(t).length,
    ui = (e, t, o, n) =>
      mi(e, t, o, li, { sibling: (e, t) => e.query().prevSibling(t), first: e => (e.length > 0 ? C.some(e[e.length - 1]) : C.none()) }, n),
    fi = (e, t, o, n) =>
      mi(e, t, o, li, { sibling: (e, t) => e.query().nextSibling(t), first: e => (e.length > 0 ? C.some(e[0]) : C.none()) }, n),
    gi = Fr(),
    ...
    ki = (e, t, o) =>
      ne(t)
        ? Oi(e, t).map(Di)
        : re(t)
        ? ((e, t, o) => (o >= 0 && o < dr(t) ? e.getRangedRect(t, o, t, o + 1) : o > 0 ? e.getRangedRect(t, o - 1, t, o) : C.none()))(
            e,
            t,
            o
          ).map(Di)
      ...
      dt(n, 'td,th', t).bind(n =>
        dt(n, 'table', t).bind(s =>
          ((e, t) => at(e, e => Re(e).exists(e => ye(e, t)), void 0).isSome())(r, s)
            ? ((e, t, o) => _i(e, t, o).bind(n => Mi(e, t, n.element, n.offset, o, 20).map(e.fromSitus)))(e, t, o).bind(e =>
                dt(e.finish, 'td,th', t).map(t => ({ start: n, finish: t, range: e }))
              )
            : C.none()
        )
      ),
    ...
    nm = Tl([{ domRange: ['rng'] }, { relative: ['startSitu', 'finishSitu'] }, { exact: ['start', 'soffset', 'finish', 'foffset'] }]),
    rm = {
      ...
      getWin: e => {
        const t = (e =>
          e.match({ domRange: e => pe.fromDom(e.startContainer), relative: (e, t) => Fc.getStart(e), exact: (e, t, o, n) => e }))(e);
      ...
      situsFromPoint: (t, o) =>
        ((e, t, o) =>
          ((e, t, o) => {
            ...
            return sm(n, t, o).map(e => Zc(pe.fromDom(e.startContainer), e.startOffset, pe.fromDom(e.endContainer), e.endOffset));
    ...
    zm = (e, t) => {
      const o = ((r = os.selectedSelector), { get: () => Qr(pe.fromDom(e.getBody()), r).fold(() => ls(Er(e), Or(e)).fold(Sm, Rm), Tm) }),
        n = ((e, t, o) => {
          const n = t => {
                          ...
                          return s.fold(
                            () =>
                              Yr(t, n.firstSelectedSelector, n.lastSelectedSelector).map(e => {
                                ...
                                return r.setRelativeSelection(Fc.on(e.first, 0), o(e.table)), n.clear(t), Hc(C.none(), !0);
                              }),
                ...
                keyup: (e, r, s, l, a) =>
                  Kr(t, n.selectedSelector).fold(() => {
                    ...
                    return !0 === c.shiftKey && em(i)
                      ? ((e, t, o, n, r, s, l) =>
                          ye(o, r) && n === s ? C.none() : dt(o, 'td,th', t).bind(o => dt(r, 'td,th', t).bind(n => ni(e, t, o, n, l))))(
                          t,
                          o,
                          r,
                          s,
          ...
          return (
            ...
            n => {
              ...
              I(t, e => D(r, e)) ||
                ((e, t) => {
                  throw new Error(
                    'All required keys (' + Lm(e).join(', ') + ') were not specified. Specified keys were: ' + Lm(t).join(', ') + '.'
                  );
                })(t, r),
                e(t, r);
              ...
              return (
                s.length > 0 &&
                  ((e, t) => {
                    throw new Error('All values need to be of type: ' + t + '. Keys (' + Lm(e).join(', ') + ') were not.');
                  })(s, o.label),
                n
              );
            }
  ...
  const $m = Hm('ephox-snooker').resolve,
    ...
    nd = e => {
      ...
      const l = (n, r) => {
          d.trigger.startAdjust(), t.assign(n), ie(n, 'data-initial-' + r, At(n, r)), xm(n, od), St(n, 'opacity', '0.2'), o.go(e.parent());
        },
        ...
        d = Wm({ adjustHeight: Am(['table', 'delta', 'row']), adjustWidth: Am(['table', 'delta', 'column']), startAdjust: Am([]) });
      return {
        destroy: () => {
