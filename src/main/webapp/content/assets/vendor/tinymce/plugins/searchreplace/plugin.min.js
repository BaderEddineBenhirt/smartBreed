...
!(function () {
    ...
    ne = (t, n) => {
      ...
      const r = f.trim(t.selection.getContent({ format: 'text' })),
        ...
        h = {
          ...
          initialData: { findtext: r, replacetext: '', wholewords: u.wholeWord, matchcase: u.matchCase, inselection: u.inSelection },
          onChange: (e, t) => {
  ...
  t.add('searchreplace', t => {
    ...
    return (
      ...
      ((e, t) => {
        e.ui.registry.addMenuItem('searchreplace', { text: 'Find and replace...', shortcut: 'Meta+F', onAction: oe(e, t), icon: 'search' }),
