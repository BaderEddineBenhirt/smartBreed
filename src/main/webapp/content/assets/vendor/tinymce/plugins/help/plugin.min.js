      ...
      e =>
        ...
        (e => {
          ...
          return null === e
            ...
            : 'object' === t &&
              ((n = o = e),
              (a = String).prototype.isPrototypeOf(n) || (null === (i = o.constructor) || void 0 === i ? void 0 : i.name) === a.name)
            ? 'string'
            : t;
          var n, o, a, i;
        })(e));
        ...
        const o = A(),
          ...
          l = (() => {
            ...
            return {
              name: 'versions',
              title: 'Version',
              items: [{ type: 'htmlpanel', html: '<p>' + x.translate(['You are using {0}', n]) + '</p>', presets: 'document' }],
            };
          })(),
