...
!(function () {
  ...
  const Ea = e => {
    ...
    Da = e =>
      e
        ? { left: Ba(e.left), top: Ba(e.top), bottom: Ba(e.bottom), right: Ba(e.right), width: Ba(e.width), height: Ba(e.height) }
        ...
        d = () => {
          (e => {
            ...
            for (let e = 0; e < o.length; e++) {
              ...
              (s = r.nextSibling),
                Mr(s) && (1 === s.data.length ? null === (n = s.parentNode) || void 0 === n || n.removeChild(s) : s.deleteData(0, 1));
            }
          })(t),
            a && (Pd(a), (a = null)),
            r.on(e => {
          ...
          if ((e => xe(e, 'id'))(t))
            return ((e, t) => {
              ...
              return Dt(n, o.or(n), (n, o) => {
                const r = e.createRng();
                return (
                  r.setStart(qc(e, n.container()), n.offset()), r.setEnd(qc(e, o.container()), o.offset()), { range: r, forward: Vc(t) }
                );
              });
            })(n, t);
          if (Hc(t))
  ...
  const tu = e => '' !== e && -1 !== ' \f\n\r\t\v'.indexOf(e),
    ...
    nm = (e, t, n, o = !1) => {
      ...
      return (
        ...
        (zu(d) || d.block_expand) &&
          ((zu(d) && Ro(r) && 0 !== s) || (r = em(l, n, r, s, !0)), (zu(d) && Ro(a) && i !== a.data.length) || (a = em(l, n, a, i, !1))),
  ...
  const cm = (e, t, n) =>
      !n.collapsed && H(n.getClientRects(), n => ((e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom)(n, e, t)),
    um = (e, t, n) => {
      e.dispatch(t, n);
    },
    mm = (e, t, n, o) => {
      ...
      const x = e => C(e) && (Lo(e) || n.is(e, 'figure.image')),
        ...
        E = e => {
          ...
          return (
            ...
            e !== t.getBody() &&
            (n.hasClass(e, 'mce-preview-object') && C(e.firstElementChild) ? pn(mn(e.firstElementChild), o) : pn(mn(e), o))
          );
        },
        N = (e, o, r) => {
          if (C(r)) {
  ...
  const dg = ['font', 'text-decoration', 'text-emphasis'],
    ...
    gp = (e, t, n, o = !0) => {
      ...
      const i = ((e, t, n) => {
        ...
        return (
          ...
          s.isSome() && a.isSome() && i.isSome() ? M.some(l(s.getOrDie(), a.getOrDie(), i.getOrDie())) : M.none()).orThunk(
        ...
        () =>
          ((e, t, n, o) => {
            ...
            return Kp(n, o).bind(o =>
              ss(o)
                ? Yp(e, o)
                : ((e, t, n, o, r) => Bc(n, e.getBody(), r).bind(e => Kp(t, mn(e.getNode())).bind(e => (bn(e, o) ? M.none() : M.some(S)))))(
                    e,
                    n,
                    t,
                    o,
    ...
    fh = e => {
      return e.length > 0 &&
        (!(n = e[e.length - 1]).firstChild ||
          (C(null == (t = n) ? void 0 : t.firstChild) && t.firstChild === t.lastChild && (e => e.data === pr || Po(e))(t.firstChild)))
        ? e.slice(0, -1)
        : e;
      var t, n;
    },
    ...
    hh = (e, t, n, o) => {
      const r = ((e, t, n) => {
        ...
        a = fh(
          ((i = r.firstChild), K(null !== (l = null == i ? void 0 : i.childNodes) && void 0 !== l ? l : [], e => 'LI' === e.nodeName))
        );
      var i, l;
      const d = t.getRoot(),
        c = e => {
          ...
          return ((e, t, n, o, r, s, a, i) => {
            ...
            if (n) {
              ...
              (a.mixed && m.isBlock(n)) || (o = null !== (l = m.split(n, o)) && void 0 !== l ? l : o),
                c && u && (null === (d = r.parentNode) || void 0 === d || d.insertBefore(c, r), u.appendChild(r), zu(a) && eb(e, a, 0, c));
            }
            return o;
          })(e, s, i, o, o, 0, a, n);
        },
            ...
            ? ((e, t, n) => {
                ...
                if (l && i > 0 && i < l.length && d.test(l.charAt(i)) && d.test(l.charAt(i - 1))) {
                  ...
                  (o && (null == s ? void 0 : s.data) === Bh) ||
                    ((c = e.getDoc()), (u = Lh(!0).dom), (o = c.importNode(u, !0)), (s = o.firstChild), a.insertNode(o), (i = 1)),
      ...
      return (
        ...
        (!!/((java|vb)script|mhtml):/i.test(o) ||
          (!e.allow_html_data_urls &&
            (/^data:image\//i.test(o)
              ? ((e, t) => (C(e) ? !e : !C(t) || !j($v, t)))(e.allow_svg_data_urls, n) && /^data:image\/svg\+xml/i.test(o)
              : /^data:/i.test(o))))
      );
    };
  class qv {
                ...
                return [
                  e => {
                    ...
                    if (3 === e.type && !m(e)) {
                      ...
                      (n = n.replace(d, ' ')),
                        (((e, t) => C(e) && (e.name in t || 'br' === e.name))(e.prev, i) || f(e, !0)) && (n = n.replace(c, '')),
                          ...
                          : n.paddEmpty &&
                            (r ||
                              (e => {
                                ...
                                return (
                                  ih(e, '#text') &&
                                  (null === (t = null == e ? void 0 : e.firstChild) || void 0 === t ? void 0 : t.value) === pr
                                );
                              })(e)) &&
                            ah(0, o, i, e);
                      }
        ...
        undo: (t, n, o) =>
          ((e, t, n, o) => {
            ...
            return (
              ...
              o.get() > 0 && (o.set(o.get() - 1), (r = t.data[o.get()]), Sy(e, r, !0), e.setDirty(!0), e.dispatch('Undo', { level: r })),
              r
            );
          })(e, t, n, o),
        redo: (t, n) =>
              ...
              .map(o =>
                Ch(t)
                  ...
                  : ((e, t, n, o) => {
                      ...
                      {
                        'raw' !== o.format &&
                          (n = ig({ validate: !1 }, e.schema).serialize(e.parser.parse(n, { isRootContent: !0, insert: !0 })));
                        ...
                        ze(o, 'blob:')
                          ? (e =>
                              fetch(e)
                                ...
                                .catch(() => Promise.reject(`Cannot convert ${e} to Blob. Resource might not exist or is inaccessible.`)))(
                              o
                            )
                          : ze(o, 'data:')
                          ? ((r = o),
  ...
  const yC = (e, t) => {
      ...
      const r = bC(),
        ...
        h = n =>
          n.replace(/src="(blob:[^"]+)"/g, (n, o) => {
            ...
            let a = t.getByUri(o);
            return (
              a || (a = Y(e.editorManager.get(), (e, t) => e || (t.editorUpload && t.editorUpload.blobCache.getByUri(o)), void 0)),
          ...
          e.on('mouseup keydown', t => {
            ((e, t) => {
              const n = e.selection,
                o = e.getBody();
              Ih(e, null, !1),
                (8 !== t && 46 !== t) || !n.isCollapsed() || n.getStart().innerHTML !== Bh || Ih(e, jc(o, n.getStart())),
    ...
    MC = [9, 27, bm.HOME, bm.END, 19, 20, 44, 144, 145, 33, 34, 45, 16, 17, 18, 91, 92, 93, bm.DOWN, bm.UP, bm.LEFT, bm.RIGHT].concat(
      Nt.browser.isFirefox() ? [224] : []
    ),
    ...
    lw = e => {
      ...
      return (
        !t.collapsed && (iw(e, !0).exists(e => e.isEqual(ai.fromRangeStart(t))) || iw(e, !1).exists(e => e.isEqual(ai.fromRangeEnd(t))))
      );
    },
    ...
    Lw = e => {
      return (
        (t = Iw(e)),
        !('rtl' === ta.DOM.getStyle(t, 'direction', !0) || (e => pp.test(e))(null !== (n = t.textContent) && void 0 !== n ? n : ''))
      );
      var t, n;
    },
  ...
  const mx = (e, t, n, o, r, s) => {
    ...
    Ax = (e, t, n) =>
      ...
      ((e, t) => {
        ...
        return (
          !!(e => w(e.selection.getSel().modify))(t) && (e && Pr(o) ? Vw(!0, t.selection, o) : !(e || !Lr(o)) && Vw(!1, t.selection, o))
        );
      })(e, t),
    Ox = e => {
      const t = ra(null),
    ...
    Mx = (e, t, n) => {
      if (e.selection.isCollapsed() && Pl(e)) {
        ...
        return ((e, t, n, o) => {
          ...
          return a
            .bind(e =>
              n ? e.fold(N(M.some(zw(e))), M.none, N(M.some(Uw(e))), M.none) : e.fold(M.none, N(M.some(Uw(e))), M.none, N(M.some(zw(e))))
            )
            .map(Px(e, t))
            .getOrThunk(() => {
              const i = Bc(n, r, o),
    ...
    hk = (e, t) => {
      ...
      return ((e, t) => {
        ...
        if (
          ((e, t, n) => (t ? ((e, t) => ex(e, t).breakAt.isNone())(e.dom, n) : ((e, t) => Zw(e, t).breakAt.isNone())(e.dom, n)))(n, t, o)
        ) {
    ...
    Yk = (e, t) => {
      ...
      return ((e, t) =>
        ((e, t, n = P) => (n(t) ? M.none() : j(e, Lt(t)) ? M.some(t) : Go(t, e.join(','), e => pn(e, 'table') || n(e))))(
          ['td', 'th'],
          e,
          t
  ...
  const uS = (e, t, n) => (e.stype === cS.Error ? t(e.serror) : n(e.svalue)),
    ...
    ES = (e, t, n, o, r) => {
      ...
      switch (e.tag) {
        case 'required':
          return ((e, t, n, o) =>
            we(t, n).fold(
              () => ((e, t, n) => hS(e, () => 'Could not find valid *required* value for "' + t + '" in ' + pS(n)))(e, n, t),
              o
            ))(t, n, o, s);
        case 'defaultedThunk':
    ...
    WS = (e, t, n) =>
      VS(
        ...
        (e => {
          return (
            (t = t => (j(e, t) ? Oi.value(t) : Oi.error(`Unsupported value: "${t}", choose one of "${e.join(', ')}".`))),
            kS(e => t(e).fold(fS, mS))
          );
          var t;
        })(n)
        ...
        h ||
          (n = ((e, t, n, o, r) => {
            ...
            if (!l || !B_(a, l)) {
              ...
              if (
                ((l = l || i),
                (s = l === e.getBody() || Uo(l) ? l.nodeName.toLowerCase() : l.parentNode ? l.parentNode.nodeName.toLowerCase() : ''),
                !l.hasChildNodes())
              ) {
                const o = a.create(t);
        ...
        if (('LI' !== x || b || ((w = s), (s = s.parentNode), (r = x)), /^(LI|DT|DD)$/.test(r) && yo(s) && i.isEmpty(w)))
          return void ((e, t, n, o, r) => {
            ...
            if (R_(n, o, !0) && R_(n, o, !1))
              ...
              __(n, 'LI') ? (s.insertAfter(d, N_(n)), d.appendChild(s.doc.createTextNode(' ')), d.appendChild(n)) : i.insertBefore(d, n),
                s.remove(o);
  ...
  const sN = (e, t) => Math.abs(e.left - t),
    ...
    aR = e => {
      ...
      (o.disabled = !0),
        (e.readonly = Kl(e)),
        e.readonly ||
          (e.inline && 'static' === JN.getStyle(o, 'position', !0) && (o.style.position = 'relative'), (o.contentEditable = 'true')),
        (o.disabled = !1),
        (e.editorUpload = xC(e)),
        (e.schema = Ls(nR(e))),
        (e.dom = ta(n, {
      ...
      return /^ | $/.test(t)
        ? ((e, t, n) => {
            ...
            return (
              ...
              Xg(o, ai.fromRangeEnd(t)) ? n.replace(/(&nbsp;| )(<br( \/)>)?$/, '&nbsp;') : n.replace(/&nbsp;(<br( \/)?>)?$/, ' ')
            );
          })(o, n.getRng(), t)
        : t;
    },
  ...
  class yA {
    ...
    getParam(e, t, n) {
      ...
      return (
        o.isRegistered(e) || (C(n) ? o.register(e, { processor: n, default: t }) : o.register(e, { processor: L, default: t })),
    ...
    save(e = {}) {
      ...
      const s = { ...o, content: r };
      if ((s.no_events || t.dispatch('SaveContent', s), 'raw' === s.format && t.dispatch('RawSaveContent', s), (r = s.content), No(n)))
        n.value = r;
      else {
  ...
  const _A = e => {
    ...
    EA = e => {
      if (e !== kA) {
        const t = ta.DOM;
        e ? (t.bind(window, 'resize', _A), t.bind(window, 'scroll', _A)) : (t.unbind(window, 'resize', _A), t.unbind(window, 'scroll', _A)),
          (kA = e);
      }
    },
    NA = e => {
