...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../animal.test-samples';

import { AnimalService, RestAnimal } from './animal.service';

const requireRestSample: RestAnimal = {
  ...sampleWithRequiredData,
  age: sampleWithRequiredData.age?.format(DATE_FORMAT),
};
